      ...
      <div className="navbar mb-2 shadow-lg bg-neutral text-neutral-content">
        ...
        <div className="navbar-center lg:flex">
          <div className="flex items-stretch">
            <Link href="/">
              <a className="btn btn-ghost btn-sm rounded-btn">首页</a>
            </Link>
            <Link href="/createPost">
              <a className="btn btn-ghost btn-sm rounded-btn">创建NFT</a>
            </Link>
            {/* <Link href="/basics">
              <a className="btn btn-ghost btn-sm rounded-btn">基础</a>
            </Link>
            <Link href="/token">
